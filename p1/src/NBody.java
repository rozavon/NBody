...
public class NBody {
	...
	public static CelestialBody[] readBodies(String fname) throws FileNotFoundException {
		...
		CelestialBody[] imgs = new CelestialBody[nb];
		...
		for(int k=0; k < nb; k++) {
			...
			CelestialBody b = new CelestialBody(x, y, xv, yv, m, n);
			imgs[k] = b;
	...
	public static void main(String[] args) throws FileNotFoundException{
		...
		for(double t = 0.0; t < totalTime; t += dt) {
			...
			for(int k=0; k < bodies.length; k++) {
				double netx = bodies[k].calcNetForceExertedByX(bodies);
				xforces[k] = netx;
				double nety = bodies[k].calcNetForceExertedByY(bodies);
				yforces[k] = nety;
  			}
